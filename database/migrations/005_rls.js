...
exports.up = async function (knex) {
  ...
  // --- barbershops: dono/equipe enxerga a própria ---
  ...
  // --- appointments: dono/equipe pela loja; cliente pelos próprios ---
  ...
  // --- users: só os próprios dados (superadmin via bypass) ---
  ...
  // --- audit_log: usuário vê o próprio rastro ---
